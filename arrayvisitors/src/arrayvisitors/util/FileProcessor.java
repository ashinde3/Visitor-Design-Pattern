...
public final class FileProcessor {
	...
	*/
	public FileProcessor(String inputFilePath)
		...
		Logger.writeMessage("In File Processor Constructor",Logger.DebugLevel.CONSTRUCTOR);
	...
	*/
	public String poll() throws IOException {
		Logger.writeMessage("In File Processor ReadLine",Logger.DebugLevel.FILE_PROCESSOR);
